...
extends ContainerFullInv<TileEntityEnergyOMat> {
    ...
    public ContainerEnergyOMatOpen(EntityPlayer player, TileEntityEnergyOMat tileEntity1) {
        ...
        this.addSlotToContainer((Slot)new SlotInvSlot(tileEntity1.demandSlot, 0, 24, 17));
        this.addSlotToContainer((Slot)new SlotInvSlot(tileEntity1.upgradeSlot, 0, 24, 53));
        this.addSlotToContainer((Slot)new SlotInvSlot(tileEntity1.inputSlot, 0, 60, 17));
        this.addSlotToContainer((Slot)new SlotInvSlot(tileEntity1.chargeSlot, 0, 60, 53));
    }
